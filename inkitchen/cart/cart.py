...
class Cart:
    ...
    def __init__(self, request):
        ...
        Мы ожидаем, что наш словарь корзины будет использовать коды продуктов в качестве ключей и словарь с количеством
    ...
    def save(self):
        """
        сохраняет все изменения в корзине в сессии и помечает сессию как modified с помощью session.modified = True.
